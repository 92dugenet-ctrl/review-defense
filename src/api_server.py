...
class ReviewDefenseAPI:
    ...
    def handle(self, environ):
        ...
        if method == "GET" and path == "/health":
            ...
            return self._json(200 if result.status == "ok" else 503, {"status": result.status, "service": "review-defense", "version": "6.39", "checks": result.checks, "checked_at": result.checked_at})
